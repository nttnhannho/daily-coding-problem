...
class Solution:
    def romanToInt(self, s: str) -> int:
        ...
        while current_idx < len(s):
            if current_idx + 1 < len(s) and roman_dict[s[current_idx]] < roman_dict[s[current_idx + 1]]:
                res += roman_dict[s[current_idx + 1]] - roman_dict[s[current_idx]]
                current_idx += 2
            else:
                res += roman_dict[s[current_idx]]
                current_idx +=1
